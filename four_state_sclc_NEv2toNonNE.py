...
# carrying_capacity_each_subtype = float(100000000) #~10^8 per cell, since LIm et al allograft they grew to 3.5 cm^3, which is about 4*10^8 cells
...
Observable('total_cells', NE() + NEv1() + NEv2() + NonNE())

# Parameter('k_ne_div', 1)
Parameter('k_NE_div_0', 0.428)  # TPCs divide approximately once per day in culture
Parameter('k_NE_div_x', 1.05)  # is the above even true?? Cellosaurus says 56 hr doubling time (24/56=.428)
...
Parameter('k_NE_die_0', 0.365)
Parameter('k_NE_die_x', 0.95)
...
Parameter('k_NEv1_div_0', 0.428)  # TPCs divide approximately once per day in culture
Parameter('k_NEv1_div_x', 1.05)
...
Parameter('k_NEv1_die_0', 0.365)
Parameter('k_NEv1_die_x', 0.95)
...
Parameter('k_NEv2_div_0', 0.428)  # TPCs divide approximately once per day in culture
Parameter('k_NEv2_div_x', 1.05)
...
Parameter('k_NEv2_die_0', 0.365)
Parameter('k_NEv2_die_x', 0.95)
...
Parameter('k_nonNE_div_0', .428)
Parameter('k_nonNE_div_x', 0.95)
...
Parameter('kf_diff_ne_nev1', 0.05)
Parameter('kr_diff_ne_nev1', 0.05)
Rule('NE_diff_NEv1', NE() | NEv1(), kf_diff_ne_nev1, kr_diff_ne_nev1)

Parameter('kf_diff_ne_nev2', 0.05)
Parameter('kr_diff_ne_nev2', 0.05)
Rule('NE_diff_NEv2', NE() | NEv2(), kf_diff_ne_nev2, kr_diff_ne_nev2)

Parameter('kf_diff_nev1_nev2', 0.05)
Parameter('kr_diff_nev1_nev2', 0.05)
Rule('NEv1_diff_NEv2', NEv1() | NEv2(), kf_diff_nev1_nev2, kr_diff_nev1_nev2)

Parameter('kf_diff_nev2_nonNe', 0.05)
...
plt.hlines(100000000,0,100,color='black')
plt.hlines(500000000,0,100,color='black')
#plt.hlines(x.all['total_cells'],[-1],0,100,color='red')
plt.vlines(60,0,500000000)
